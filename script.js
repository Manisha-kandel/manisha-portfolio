...
const BOOKS = {
  pristine: [
    { title:'War and Peace',   author:'Leo Tolstoy', emoji:'⚔️', note:'Halfway through. The scale — historical, emotional, philosophical — is unlike anything else.' },
    { title:'Anna Karenina',   author:'Leo Tolstoy', emoji:'🌹', note:'On the list. Tolstoy dissecting society and desire with surgical precision.' },
  ],
  shabby: [
    { title:'Shadow and Bone',                      author:'Leigh Bardugo',                   emoji:'🌑', note:'Grisha magic system, sharp world-building.' },
    { title:'Dreaming Death',                       author:'J. Kathleen Cheney',              emoji:'💭', note:'Palace intrigue, psychic detective noir.' },
    { title:'The Broken Wings',                     author:'Kahlil Gibran',                   emoji:'🕊️', note:'Gibran at his most lyrical and heartbroken.' },
    { title:'The Living Corpse',                    author:'Leo Tolstoy',                     emoji:'🕯️', note:'Tolstoy at his moral-crisis finest.' },
    { title:'The Pearl of Lima',                    author:'Jules Verne',                     emoji:'🦪', note:'Rare Verne — romantic, adventurous, understated.' },
    { title:'Rich Dad Poor Dad',                    author:'Robert Kiyosaki & Sharon Lechter',emoji:'💰', note:'Reframes money as systems, not salary.' },
    { title:'The First Twenty Hours',               author:'Josh Kaufman',                    emoji:'⏱️', note:'Rapid skill acquisition, methodically deconstructed.' },
    { title:'Think and Grow Rich',                  author:'Napoleon Hill',                   emoji:'🧠', note:'Early self-development canon. Holds up.' },
    { title:"Alice's Adventures in Wonderland",     author:'Lewis Carroll',                   emoji:'🐇', note:'Absurdist logic as children\'s philosophy.' },
    { title:'Our Little Spanish Cousin',            author:'Mary Nixon-Roulet',               emoji:'🇪🇸', note:'Edwardian travelogue, vanished world charm.' },
    { title:'To Be Read at Dusk',                   author:'Charles Dickens',                 emoji:'🌆', note:'Quiet, gothic, unmistakably Dickens.' },
    { title:'The Man Who Was Thursday: A Nightmare',author:'G.K. Chesterton',                emoji:'🎩', note:'Philosophical anarchist thriller. Deeply strange.' },
    { title:'Yesterday House',                      author:'Fritz Leiber',                    emoji:'🏚️', note:'Domestic uncanny. Time, grief, dread.' },
    { title:'The Blue Germ',                        author:'Maurice Nicoll',                  emoji:'🔵', note:'Early sci-fi parable on immortality.' },
    { title:'We Should All Be Feminists',           author:'Chimamanda Ngozi Adichie',        emoji:'✊', note:'Precise, generous, necessary.' },
    { title:'Sharp Objects',                        author:'Gillian Flynn',                   emoji:'🔪', note:'Flynn\'s most personal. Psychological and brutal.' },
    { title:'Memories of My Melancholy Whores',     author:'Gabriel García Márquez',          emoji:'🌺', note:'Late GGM — elegiac, strange, unmistakable.' },
    ...
    { title:'Think Like a Monk',                    author:'Jay Shetty',                      emoji:'🧘', note:'Ancient Vedic wisdom, modern framing.' },
  ]
};
